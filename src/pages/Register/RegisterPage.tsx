...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (success) {
      ...
      setAuthError('No se pudo crear la cuenta. Intentá con otro correo.')
    }
  }
    ...
    >
      ...
      >
        ...
        <div className="text-center">
          ...
          <p className="text-slate-400 text-sm mt-2">Creá tu cuenta</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="flex flex-col gap-1.5">
              ...
              />
              {errors.firstName && (
                <span style={{ color: '#f07060' }} className="text-xs">{errors.firstName}</span>
              )}
            </div>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              />
              {errors.lastName && (
                <span style={{ color: '#f07060' }} className="text-xs">{errors.lastName}</span>
              )}
            </div>
          </div>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            {errors.confirmPassword && (
              <span style={{ color: '#f07060' }} className="text-xs">{errors.confirmPassword}</span>
            )}
          </div>
