...
export default function Layout() {
  ...
  return (
    <div style={{ backgroundColor: "#0D1520" }} className="flex flex-col min-h-screen">
      ...
      {/* Footer — ancho completo fuera del flex row */}
      <footer
        style={{
          backgroundColor: "#090F1A",
          borderTop: "1px solid #1e3a5f",
        }}
        className="w-full px-8 py-4 flex items-center justify-center"
      >
